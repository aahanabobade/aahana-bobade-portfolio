# Aahana Bobade — Developer Portfolio
...
Live site: https://aahanabobade-portfolio.vercel.app
...
├── public/
│   └── Aahana_Bobade_Resume.pdf # Resume (served as static asset)
├── src/
│   ├── components/
...
│   │   └── CopilotChat.jsx       # AI assistant panel
│   ├── pages/
...
The portfolio includes a built-in AI chat panel that answers questions about Aahana's projects, experience, skills, and background.
