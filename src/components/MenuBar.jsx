...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// Portal dropdown used for every menu
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
function Item({ label, shortcut, onClick, disabled = false, danger = false }) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      ...
      style={{ color: danger ? 'var(--red)' : 'var(--text)', background: 'transparent' }}
...
export default function MenuBar({
  ...
  const [openMenu, setOpenMenu] = useState(null) // 'file' | 'edit' | 'view' | 'go' | 'run' | 'terminal' | 'help'

  const refs = {
    file:     useRef(), edit:    useRef(), view:  useRef(),
    go:       useRef(), run:     useRef(), terminal: useRef(), help: useRef(),
  }
        ...
        <MenuDropdown anchorRef={refs.view} open={openMenu === 'view'} onClose={close}>
          ...
          <Item
            ...
            onClick={() => act(() => {
              ...
              const cur = parseFloat(el.style.fontSize || '100')
              el.style.fontSize = Math.min(cur + 10, 150) + '%'
            })}
          />
          <Item
            label="Zoom Out"
            ...
            onClick={() => act(() => {
              const el = document.documentElement
              const cur = parseFloat(el.style.fontSize || '100')
              el.style.fontSize = Math.max(cur - 10, 70) + '%'
            })}
          />
          <Item
            label="Reset Zoom"
            onClick={() => act(() => { document.documentElement.style.fontSize = '' })}
          />
        </MenuDropdown>
      </div>
      ...
      <div ref={refs.terminal}>
        ...
        <MenuDropdown anchorRef={refs.terminal} open={openMenu === 'terminal'} onClose={close}>
          ...
          <Item
            ...
            onClick={() => act(() => {
              // fire a custom event the Terminal component can listen to
